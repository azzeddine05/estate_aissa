            ...
            <div id="content">
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="row mb-4">
                            <form id="frm" method="post" action="{{url('/estate/buy')}}">
                            {{csrf_field()}}
                            <div class="col-12 col-md-12 mb-4">
                                ...
                                <h6 class="header-title pr-3 redial-relative"> عملية بيع عقار </h6>
                            ...
                            <div class="col-12 col-xl-4 mb-4 mb-xl-0">
                                <div class="card redial-border-light redial-shadow">
                                    <div class="card-body">
                                        <h6 class="header-title pr-3 redial-relative">معلومات المشتري </h6><br>
                            
                                            <div class="form-group">
                                                <label class="redial-font-weight-600">إسم المشتري </label>
                                                <input type="text" name="name_purchaser" class="form-control" placeholder="" />
                                            </div>
                                            <div class="form-group">
                                                <label class="redial-font-weight-600">رقم المشتري </label>
                            ...
                            <div class="col-12 col-xl-4 mb-4 mb-xl-0">
                                <div class="card redial-border-light redial-shadow">
                                    <div class="card-body">
                                        <h6 class="header-title pr-3 redial-relative">معلومات البيع</h6><br>
                                   
                                            <div class="row">
                                                <div class="form-group buytext">
                                                    <label class="redial-font-weight-600">قيمة العقار </label>
                                            ...
                                            <div class="row">
                                                <div class="form-group buytext">
                                                    <label class="redial-font-weight-600">المبلغ المتبقي </label>
                                                    <input type="text" name="remaining_amount" class="form-control" placeholder="" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group buytext">
                                                    <label class="redial-font-weight-600">رقم الوتيقة </label>
                                                    <input type="text" name="document_number" class="form-control" placeholder="" />
                                                </div>
                                                <div class="form-group buytext">
                                                    <label class="redial-font-weight-600">رقم المقدمة </label>
                                                    <input type="text" name="submitted_number" class="form-control" placeholder="" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group buytext">
                            ...
                            <div style="margin-right: 425px; margin-top: 2px;" class="btn-group mb-2">
                                <button type="submit" class="btn btn-success btn-default">أكمل عملية البيع</button>
                            </div>
                        </form>
                        </div>
