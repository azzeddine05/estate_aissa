                        ...
                        <div class="row mb-4">
                            <div class="col-12 col-md-12">
                                <div class="card redial-border-light redial-shadow mb-4">
                                    ...
                                    @if(session()->has('enableEstate'))
                                    <div style="font-family:changa;" class="alert alert-success">
                                        {{ session()->get('enableEstate') }}
                                    </div>
                                    @endif 

                                    @if(session()->has('disableEstate'))
                                    <div style="font-family:changa;" class="alert alert-success">
                                        {{ session()->get('disableEstate') }}
                                    </div>
                                    @endif
                                            ...
                                            @foreach($estates as $estate)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="btn-group mb-2">
                                                            <a href="{{ URL::to('admin-estate/enable/'.$estate->id_estate) }}" type="button" title="الموافقة على العقار" class="btn btn-success"><i class="fa fa-check"></i></a>
                                                        </div>
                                                        @else
                                                        <div class="btn-group mb-2">
                                                            <a href="{{ URL::to('admin-estate/disable/'.$estate->id_estate) }}" type="button" title="إيقاف العقار " class="btn btn-danger"><i class="fa fa-check"></i></a>
                                                        </div>
                                                        @endif
